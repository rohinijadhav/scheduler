...
if (!/javascriptkit\.com(\/)*$/i.test(location.href)){ //home page test
	if (/(javatutors\/)|(dhtmltutors\/)|(howto\/)/i.test(location.href) && /\.shtml/i.test(location.href)){
		document.write('<div id="bsap_1279042" class="bsarocks bsap_dd6e9fbb78d92ec298f6119b05509777"><\/div>')
	}
...
document.write('<li><a href="http://www.javascriptkit.com/bookmark.php?d=furl&title='+encodeURIComponent(document.title)+'">Bookmark</a> to Furl.net</li></ul>')
}